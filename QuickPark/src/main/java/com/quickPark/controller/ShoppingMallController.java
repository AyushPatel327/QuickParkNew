...
public class ShoppingMallController {
	...
	public ResponseEntity<String> login(@RequestBody AuthoriseUser user) {
		return new ResponseEntity<String>(mallService.authoriseShoppingMall(user), HttpStatus.ACCEPTED);
	}
	...
	@GetMapping("/getMallIdByMallEmail/{mallEmail}")
	public ResponseEntity<Integer> getShoppingMallIdByEmail(@PathVariable String mallEmail){
		
		return new ResponseEntity<Integer>(mallService.getShoppingMallByEmail(mallEmail),HttpStatus.FOUND);
	}
